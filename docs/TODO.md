...
- [ ] **신청 기록 자동 삭제** — 활동 종료 30일 경과분 삭제. 기존 keep-alive 워크플로에 단계 추가
      폼에서 이미 "30일 이내 삭제"라고 고지했다. 약속한 것을 지키는 코드가 아직 없다.
